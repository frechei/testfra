 ...
 */
package org.haotao.common.widget;
...
/** 
* @Description: 弹性效果的scrollview
* @author haitao 
* @date 2015-11-19 下午2:21:04 
* @version V1.0   
*/
public class ElScrollView extends ScrollView {
    ...
    public ElScrollView(Context context) {
        super(context);
    }

    public ElScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
